...
%     {
%         int j = (i ? (n - i) : i);
%         base ans1 = (v1[i] + conj(v1[j])) * base(0.5
%                     ,
%                     0);
%         base ans2 = (v1[i] - conj(v1[j])) * base(
%                         0, -0.5);
%         base ans3 = (v2[i] + conj(v2[j])) * base(0.5
%                     ,
%                     0);
%         base ans4 = (v2[i] - conj(v2[j])) * base(
%                         0, -0.5);
%         r1[i] = (ans1 * ans3) + (ans1 * ans4) * base(
%                     0
%                     ,
%                     1);
%         r2[i] = (ans2 * ans3) + (ans2 * ans4) * base(
%                     0
%                     ,
%                     1);
%     }
